...
console.log("Eser 5:");
const prezzoIVAto = (prezzo) => prezzo + prezzo * 0.22;
console.log(prezzoIVAto(100));
// 6) Crea una funzione che concateni due stringhe e restituisca la lunghezza totale.
console.log("Eser 6:");
const strConc = (str1, str2) => str1.concat(str2).length;
...
console.log("Eser 11:");
const myTupla = ["mi chiamo", "Mark", "ho", 3, 0];
...
console.log({ myAuto });
console.log("I have a car and it's brand is", myAuto.modello, "from", myAuto.brand, "house.", "It has", myAuto.porte, "doors and", myAuto.posti, "seats.", "Its horsepower can go up to", myAuto.cavalli);
...
console.log({ Alien });
console.log("Il film", Alien.name, "è uscito il", new Date(Alien.release_date).toLocaleDateString(), "ed ha una durata di", Alien.duration, "minuti.", "I suoi generi sono:", Alien.genre[0], "ed", Alien.genre[1]);
